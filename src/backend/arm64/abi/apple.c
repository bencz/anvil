...
static const int apple_caller_saved[] = {
    ARM64_X0, ARM64_X1, ARM64_X2, ARM64_X3, ARM64_X4, ARM64_X5, ARM64_X6, ARM64_X7,
...
static void apple_compute_frame_layout(const AnvilABI* abi, const AnvilTargetInfo* target,
...
static void apple_emit_string(const AnvilABI* abi, const char* label, 
...
const AnvilABI arm64_apple_abi = {
    .name = "apple_arm64",
    
    .arg_regs_int = apple_arg_regs_int,
    .num_arg_regs_int = sizeof(apple_arg_regs_int) / sizeof(apple_arg_regs_int[0]),
    .arg_regs_float = apple_arg_regs_float,
    .num_arg_regs_float = sizeof(apple_arg_regs_float) / sizeof(apple_arg_regs_float[0]),
    
    .ret_reg_int_lo = ARM64_X0,
    .ret_reg_int_hi = ARM64_X1,
    .ret_reg_float = ARM64_V0,
    
    .callee_saved_regs = apple_callee_saved,
    .num_callee_saved = sizeof(apple_callee_saved) / sizeof(apple_callee_saved[0]),
    .caller_saved_regs = apple_caller_saved,
    .num_caller_saved = sizeof(apple_caller_saved) / sizeof(apple_caller_saved[0]),
    ...
    .compute_frame_layout = apple_compute_frame_layout,
    .format_symbol = NULL,
    .emit_call = NULL,
    .emit_string = apple_emit_string,
    .is_variadic = NULL,
    .emit_variadic_arg = NULL,
    
    .uses_underscore_prefix = true,
    .variadic_args_on_stack = true,
};
