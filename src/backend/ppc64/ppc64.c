...
static const char *ppc64_gpr_names[] = {
...
/* Argument registers */
static const int ppc64_arg_regs[] = { PPC64_R3, PPC64_R4, PPC64_R5, PPC64_R6, PPC64_R7, PPC64_R8, PPC64_R9, PPC64_R10 };
...
static void ppc64_emit_func(ppc64_backend_t *be, anvil_func_t *func);
static void ppc64_emit_instr(ppc64_backend_t *be, anvil_instr_t *instr, anvil_func_t *func);
...
static int ppc64_add_stack_slot(ppc64_backend_t *be, anvil_value_t *val)
{
...
static int ppc64_get_stack_slot(ppc64_backend_t *be, anvil_value_t *val)
{
...
static const char *ppc64_add_string(ppc64_backend_t *be, const char *str)
{
...
static void ppc64_emit_prologue(ppc64_backend_t *be, anvil_func_t *func)
{
...
static void ppc64_emit_epilogue(ppc64_backend_t *be, anvil_func_t *func)
{
    size_t frame_size = func->stack_size;
    if (frame_size < PPC64_MIN_FRAME_SIZE) frame_size = PPC64_MIN_FRAME_SIZE;
...
static void ppc64_emit_load_value(ppc64_backend_t *be, anvil_value_t *val, int reg, anvil_func_t *func)
{
    if (!val) return;
...
static void ppc64_emit_block(ppc64_backend_t *be, anvil_block_t *block, anvil_func_t *func)
{
    if (!block) return;
...
static void ppc64_emit_globals(ppc64_backend_t *be, anvil_module_t *mod)
{
...
static void ppc64_emit_strings(ppc64_backend_t *be)
{
